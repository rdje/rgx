# Copilot bootstrap — RGX (one-line pointer; do not duplicate the system here)

Read `README.md` and `MEMORY_ARCHITECTURE.md` first, then `AGENTS.md` for the
full agent bootstrap. Memory is layered: A `MEMORY.md` (bounded resume pointer)
