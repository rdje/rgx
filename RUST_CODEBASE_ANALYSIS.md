...
- The biggest remaining gaps are now narrower and clearer:
  ...
  - the real PGEN backend is green locally through pinned submodule commit `962acfd9004326011efde5c0a3ba91e10e260aac` (PGEN 1.1.3)
...
- The PGEN dependency is now pinned as `subs/pgen` at commit `962acfd9004326011efde5c0a3ba91e10e260aac` (PGEN 1.1.3).
