...
| --- | --- | --- | --- | --- |
| `MEMORY-ARCHITECTURE-DOC` | [tasks/MEMORY-ARCHITECTURE-DOC.md](tasks/MEMORY-ARCHITECTURE-DOC.md) | `active` | `MEMORY-ARCHITECTURE-DOC.1` (author standard) | Governance / process (memory durability) |
