...
- Perl extended character classes `(?[...])`
  - RGX now ships a grouped bracket/property/shorthand/escaped-term subset with unary complement and same-level multi-operator precedence
  - wider set-expression forms and additional bare-term families beyond the current bracket/property/shorthand/escaped-term subset remain open
