...
```
The default RGX build now expects the committed `subs/pgen` submodule carrying the pinned PGEN regex `1.1.10` release (adds PCRE2 VERSION conditionals, closes PGEN-RGX-0016).
