...
- Scope:
  ...
  - extend Perl extended character classes `(?[...])` beyond the newly shipped grouped bracket/property/shorthand/escaped-term subset, now including horizontal/vertical whitespace shorthands (`\h`, `\H`, `\v`, `\V`), with explicit runtime policy for wider set-expression forms and any further bare-term families
