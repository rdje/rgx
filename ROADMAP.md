...
- Scope:
  ...
  - extend Perl extended character classes `(?[...])` beyond the newly shipped grouped bracket/property/shorthand subset, with explicit runtime policy for wider set-expression forms and any further bare-term families
