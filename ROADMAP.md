...
- Scope:
  ...
  - extend Perl extended character classes `(?[...])` beyond the newly shipped grouped bracket/property/POSIX/shorthand/escaped-term subset, now including horizontal/vertical whitespace shorthands (`\h`, `\H`, `\v`, `\V`) plus bare ASCII POSIX class terms, with explicit runtime policy for wider set-expression forms and any further bare-term families
