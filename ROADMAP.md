...
- Scope:
  ...
  - extend Perl extended character classes `(?[...])` beyond the newly shipped grouped bracket/property/POSIX/shorthand/escaped-term subset, now also including control/octal escaped atoms such as `\cA`, `\040`, and `\o{101}`, with explicit runtime policy for wider set-expression forms and any further bare-term families
