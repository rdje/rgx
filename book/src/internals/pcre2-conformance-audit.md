...
- **PCRE2 source of truth**: `subs/pcre2` submodule pinned to 10.47 (commit `f454e231`); `subs/pgen` submodule pinned to PGEN 1.1.80 (commit `5fd20609`, contract 1.1.82).
