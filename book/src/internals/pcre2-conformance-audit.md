...
- **PGEN-issue tracker**: `pgen-issues/PGEN-RGX-NNNN.yaml`. 88 filed, 87 closed; only `PGEN-RGX-0073` (compile-time perf) remains open and is non-conformance (`PGEN-RGX-0078` was its superseded PCRE2-relative re-file). The `\NN…` octal-vs-backref cluster 0084/0085/0086/0087/0088 is fully resolved.
