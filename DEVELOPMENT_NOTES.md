...
- The current PGEN-backed integration now depends on the committed `subs/pgen` submodule:
  - the pinned fix commit is `11821c49a935bff28bcf72a8e63aacf3c2be3fd7` (PGEN 1.1.5, includes braced octal, numeric angle subroutine, and tagged code-block fixes)
