...
- The current PGEN-backed integration now depends on the committed `subs/pgen` submodule:
  - the pinned fix commit is `f876a609b22dad349572cf9421de8bf0af0e5183` (PGEN 1.1.6, includes braced octal, numeric angle subroutine, and tagged code-block fixes)
